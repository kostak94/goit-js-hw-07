...
for (let i = 0; i < images.length; i++) {
  ...
  imgTag.setAttribute("src", images[i].url);
  imgTag.setAttribute("alt", images[i].alt);
  liTag.append(imgTag);
  imgsArr.push(liTag);
}
listOfImages.append(...imgsArr);

// function markupTemplate(obj) {
//   return `<li>
//   <img src=${obj.url} alt=${obj.alt}/>
// </li>`;
// }

// function imagesExample(array) {
//   const markUp = array.map(markupTemplate).join("");
//   return markUp;
// }

// listOfImages.insertAdjacentHTML("afterbegin", imagesExample(images));
